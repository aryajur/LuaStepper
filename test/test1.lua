...
print(LuaStepper.addTask(script1,"print('Initialization step 1') print('Initialization step 2')"))

--script2 = "for i=1,20 do print('Script 2 i:',i) end"
script2 = "while true do print('C') end"
--script2 = "print('I am done')"
print(LuaStepper.addTask(script2,"print('Initialization step x') print('Initialization step y')"))
...
print(LuaStepper.addTask(script3,"print('Adding Script 3')",5,true))

print(LuaStepper.getNumOfTasks())
print("Start stepper loop")
--while(true) do
for i=1,50 do
	x,y=LuaStepper.runLoop()
	...
	if i==5 then
		print("i=5",LuaStepper.taskStatus(0))
		print("i=5",LuaStepper.taskStatus(1))
	end
	if i==30 then
		print("i=30",LuaStepper.taskStatus(0))
		print("i=30",LuaStepper.taskStatus(1))
	end
	if i==20 then
		print("C suspended")
	...
	if i==5 then
		x,y = LuaStepper.getTaskData(4,"test3")
		if x then
			print("Value from script3 test3=",x)
			print(LuaStepper.setTaskData(4,{test4=x}))
		else
